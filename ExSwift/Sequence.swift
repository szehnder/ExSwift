...
//    */
//    func filter(include: (Element) -> Bool) -> AnySequence<T> {
...
//        :returns: Filtered sequence
//    */
//    func reject (exclude: (Element -> Bool)) -> AnySequence<T> {
//        return self.filter {
//            return !exclude($0)
//        }
//    }
...
//    */
//    func skipWhile(condition:(Element) -> Bool) -> AnySequence<T> {
//        let generator =  self.generate()
...
//    */
//    func takeWhile (condition:(Element?) -> Bool) -> AnySequence<T>  {
